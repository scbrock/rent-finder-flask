...
**Current Phase:** ✅ MC-328 in review. Per-neighbourhood 30-day price-trend chart shipped on the drill-down page (`/api/neighborhoods/<slug>/price-history` + Chart.js line charts in `templates/neighborhood.html`). 35/35 MC-328 tests pass; 0 regressions in MC-320/321/325/327/test_app.
